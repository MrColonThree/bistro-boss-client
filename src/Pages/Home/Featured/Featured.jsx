...
const Featured = () => {
  return (
    <div className="featured-item   bg-fixed my-20">
      <div className="inset-0 bg-opacity-50 bg-black pt-8 ">
        ...
        <div className="md:flex justify-center items-center gap-10 pb-20 md:px-36 text-white relative">
          ...
          <div className="text-content">
            ...
            <p>
              ...
              cumque deserunt accusantium quidem voluptates tenetur animi!
              Dolorum magni labore dolor assumenda dolores?
            </p>
